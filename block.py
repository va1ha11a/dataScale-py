...
def put_chunk(bucket, chunk_name, chunk_data, chunk_len, minio_connection=minioClient):
       try:
              minio_connection.put_object(bucket, chunk_name, io.BytesIO(chunk_data), chunk_len)
